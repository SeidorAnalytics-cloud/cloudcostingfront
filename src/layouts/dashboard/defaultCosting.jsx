...
//default 
import CostingRouter from '../../router/costingRouter'
    ...
    return (
        <>
            ...
            <Sidebar />
                ...
                {location.pathname !== '/cloudcosting/distribution' && (
...
export default connect(mapStateToProps, mapDispatchToProps)(DefaultCosting)
